...
if(isset($_POST['signup']))
{
    ...
    $sql = "INSERT INTO tblstudents 
            (FullName, MobileNumber, EmailId, Password, Status)
    ...
    /* ============================
       GENERATE STUDENT ID
    ============================ */
    $lastId = $dbh->lastInsertId();   // e.g. 1, 2, 3...

    // AIML001, AIML002...
    $studentId = "AIML" . str_pad($lastId, 3, "0", STR_PAD_LEFT);
    ...
    $update->bindParam(':sid', $studentId);
    $update->bindParam(':id', $lastId);
    $update->execute();
